...
using Smile;
using Constants = KaVE.RS.Commons.CodeCompletion.SmilePBNRecommenderConstants;
using Fix = KaVE.RS.Commons.Tests_Unit.CodeCompletion.SmilePBNRecommenderFixture;

namespace KaVE.RS.Commons.Tests_Unit.CodeCompletion
{
    [TestFixture]
